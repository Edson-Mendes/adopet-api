...
public interface AdoptionControllerSwagger {
  ...
  @Operation(
      ...
      description = "Request an adoption by specifying a petId on request body. " +
          "The response, if successful, is a JSON with information about requested adoption. " +
          "Only guardians can adopt a pet.",
      tags = {"Adoption"}
  )
  @ApiResponses(value = {
  ...
  @Operation(
      ...
      description = "Delete Adoption by specifying its id. Only the shelter related to the adoption can delete it.",
      tags = {"Adoption"})
  @ApiResponses(value = {
      @ApiResponse(
